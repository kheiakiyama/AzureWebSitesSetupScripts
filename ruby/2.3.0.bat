...
curl -LOs http://dl.bintray.com/oneclick/rubyinstaller/ruby-2.3.0-x64-mingw32.7z

7za x ruby-2.3.0-x64-mingw32.7z > nul
rm -f ruby-2.3.0-x64-mingw32.7z

mv ruby-2.3.0-x64-mingw32 2.3.0 & cd 2.3.0

set PATH=%PATH%;D:\home\site\wwwroot\bin\ruby\2.3.0\bin
...
ruby dk.rb init
echo - D:\home\site\wwwroot\bin\ruby\2.3.0 >> config.yml
ruby dk.rb install